                        ...
                        <div className="text-align-center">
                          ...
                          >
                            ...
                            >
                              ...
                              millions in costs and countless hours. Now it's
                              your turn to streamline your data and unlock the
                              value of your data faster.
                            </p>
                          </div>
                        </div>
                        <div className="spacer-small"></div>
                                ...
                                <div className="data-fabrics_tab_menu">
                                  ...
                                  <div className="data-fabrics_tab_list">
                                    <div className="data-fabrics_tab_item">
                                      ...
                                      <div className="spacer-0-75rem"></div>
                                      <div className="text-size-tiny">
                                        reduction in SIEM and observability
                                        spend
                                      </div>
                                    </div>
                                    <div className="data-fabrics_tab_item">
                                ...
                                <div className="data-fabrics_tab_menu">
                                  ...
                                  <div className="data-fabrics_tab_list">
                                    ...
                                    <div className="data-fabrics_tab_item">
                                      ...
                                      <div className="spacer-0-75rem"></div>
                                      <div className="text-size-tiny">
                                        reduced data ops effort through
                                        automation
                                      </div>
                                    </div>
                                  </div>
